    ...
    */
    ...
    'connections' => [
        ...
        'pgsql_migrator' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '5432'),
            'database' => env('DB_MIGRATOR_DATABASE', env('DB_DATABASE', 'aiop')),
            'username' => env('DB_MIGRATOR_USERNAME', 'aiop_migrator'),
        ...
        'pgsql_consola' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '5432'),
            'database' => env('DB_DATABASE', 'aiop'),
            'username' => env('DB_CONSOLA_USERNAME', 'aiop_consola'),
            'password' => env('DB_CONSOLA_PASSWORD', ''),
            'charset' => env('DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
